...
| ![clones](web/assets/clones.png) | ` ArrayList<SpriteClass> SpriteClassArray = new ArrayList<SpriteClass>();` <br><br>  `SpriteClassArray.add(new SpriteClass());` <br><br><br>  `drawClones(SpriteClassArray)` <br><br>` SpriteClassArray.remove(this);`| The array that contains the class to clone <br><br><br>   Add a new class instance in the ArrayList <br><br><br> Display each clone <br><br><br> Remove the clone from the ArrayList, should be call inside the class | 
