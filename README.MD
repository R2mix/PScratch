...
| ![clones](web/assets/clones.png) | ` ArrayList<SpriteClass> SpriteClassArray = new ArrayList<SpriteClass>();// SpriteClassArray.add(new SpriteClass()); ` | The array that contains the class to clone  |  | ` SpriteClassArray.add(new SpriteClass()); `| Add a new class instance in the ArrayList |
